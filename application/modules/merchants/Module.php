...
class Module extends ApplicationModule
{
	...
	public static function initRoutes(DiInterface $di)
	{
		...
		$loader->registerNamespaces([
			'Karts\Merchants'                 => __DIR__,
			'Karts\Merchants\Controllers'     => __DIR__ . '/controllers/',
			], true)
			->register();
		...
		if ( isset($moduleConfig['controllers']['annotationRouted']) ) {
			foreach ($moduleConfig['controllers']['annotationRouted'] as $ctrl) {
				$router->addModuleResource('merchants', $ctrl, '/merchants');	
			}
		}
	}
	...
	public function registerAutoloaders(DiInterface $di = NULL)
	{
		...
		$loader->registerNamespaces([
				'Karts\Merchants'                 => __DIR__,
				'Karts\Merchants\Controllers'     => __DIR__ . '/controllers/',
				'Karts\Merchants\Controllers\API' => __DIR__ . '/controllers/api/',
				'Karts\Merchants\Models'          => __DIR__ . '/models/',
				'Karts\Merchants\Library'         => __DIR__ . '/libraries/',
			], true)
			->register();
	}
	...
	public function registerServices(DiInterface $di)
	{
		...
		$di->set('dispatcher', function () use ($di) {
			...
			$dispatcher->setDefaultNamespace('Karts\Merchants\\');
